...
class NativeMethod implements Callable {
  static final _stringRegistry =
      <String, NativeMethodDefinition<String, Object>>{};
  static final _listRegistry =
      <String, NativeMethodDefinition<List<Object>, Object>>{};
  static final _mapRegistry =
      <String, NativeMethodDefinition<Map<String, Object>, Object>>{};
  ...
  static final _dateRegistry =
      <String, NativeMethodDefinition<DateTime, Object>>{};
  static final _durationRegistry =
      <String, NativeMethodDefinition<Duration, Object>>{};
  static final _futureRegistry =
      <String, NativeMethodDefinition<Future<Object>, Object>>{};

  static Map<String, NativeMethodDefinition> getNativeMethodsForType(
    NativeMethodTarget target,
  ) {
    switch (target) {
  ...
  static void registerNativeMethod<T extends Object, R extends Object>(
    NativeMethodDefinition<T, R> definition,
  ) {
    switch (definition.targetType) {
      case NativeMethodTarget.string:
        _stringRegistry[definition.methodName] =
            definition as NativeMethodDefinition<String, R>;
        break;
      case NativeMethodTarget.list:
        _listRegistry[definition.methodName] =
            definition as NativeMethodDefinition<List<Object>, R>;
        break;
      case NativeMethodTarget.map:
        _mapRegistry[definition.methodName] =
            definition as NativeMethodDefinition<Map<String, Object>, R>;
        break;
      case NativeMethodTarget.number:
        _numRegistry[definition.methodName] =
            definition as NativeMethodDefinition<num, R>;
        break;
      case NativeMethodTarget.boolean:
        _boolRegistry[definition.methodName] =
            definition as NativeMethodDefinition<bool, R>;
        break;
      case NativeMethodTarget.date:
        _dateRegistry[definition.methodName] =
            definition as NativeMethodDefinition<DateTime, R>;
        break;
      case NativeMethodTarget.duration:
        _durationRegistry[definition.methodName] =
            definition as NativeMethodDefinition<Duration, R>;
        break;
      case NativeMethodTarget.future:
        _futureRegistry[definition.methodName] =
            definition as NativeMethodDefinition<Future<Object>, R>;
        break;
    }
  }
  ...
  Future<Object?> call(dynamic interpreter, List<dynamic> arguments) async {
    ...
    if (target is List) {
      return await _listMethods(
        (target as List).cast<Object>(),
        interpreter,
        arguments,
      );
    }
    ...
    if (target is Map) {
      return await _mapMethods(
        (target as Map).cast<String, Object>(),
        interpreter,
        arguments,
      );
    }
    ...
    if (target is Future<Object>) {
      return await _futureMethods(
        target as Future<Object>,
        interpreter,
        arguments,
      );
    }
    ...
    throw RuntimeError(
      "NativeMethod -> Unable to find method $methodName on $target",
    );
  }
  ...
  FutureOr<Object> _futureMethods(
    Future<Object> target,
    dynamic interpreter,
    List<dynamic> arguments,
  ) {
    if (_futureRegistry.containsKey(methodName)) {
      return _futureRegistry[methodName]!.function(
        target,
        interpreter,
        arguments,
      );
      ...
      throw RuntimeError(
        "NativeMethod -> Unknown method $methodName on $target",
      );
    }
  }

  FutureOr<Object> _boolMethods(
    bool target,
    dynamic interpreter,
    List<dynamic> arguments,
  ) {
    if (_boolRegistry.containsKey(methodName)) {
      return _boolRegistry[methodName]!.function(
        target,
        interpreter,
        arguments,
      );
  ...
  FutureOr<Object> _dateMethods(
    DateTime target,
    dynamic interpreter,
    List<dynamic> arguments,
  ) {
    if (_dateRegistry.containsKey(methodName)) {
      return _dateRegistry[methodName]!.function(
        target,
        interpreter,
        arguments,
      );
  ...
  FutureOr<Object> _durationMethods(
    Duration target,
    dynamic interpreter,
    List<dynamic> arguments,
  ) {
    if (_durationRegistry.containsKey(methodName)) {
      return _durationRegistry[methodName]!.function(
        target,
        interpreter,
        arguments,
      );
  ...
  FutureOr<Object?> _listMethods(
    List<Object> target,
    dynamic interpreter,
    List<dynamic> arguments,
  ) {
    if (_listRegistry.containsKey(methodName)) {
      return _listRegistry[methodName]!.function(
        target,
        interpreter,
        arguments,
      );
  ...
  FutureOr<Object?> _stringMethods(
    String target,
    dynamic interpreter,
    List<dynamic> arguments,
  ) {
    if (_stringRegistry.containsKey(methodName)) {
      return _stringRegistry[methodName]!.function(
        target,
        interpreter,
        arguments,
      );
